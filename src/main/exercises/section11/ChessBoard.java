...
import static exercises.section11.Coordinates.convertLocation;

//1. Revise the chess modeling from Section 8, exercise 8 to throw an exception when a chess
//        piece tries to move to a square occupied by a friendly piece. Consider what is an
//        appropriate type of exception for this.
//        2. Try using ptionals in the chess modeling exercise instead of null values throughout the
//        code.
